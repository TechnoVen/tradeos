...
# Start logging
log_message "Starting TradeOS Simple HTTP installation" "$BLUE"
...
log_message "\nStarting TradeOS installation..." "$YELLOW"
...
# Installation paths
BASE_PATH="/var/python/tradeos"
VENV_PATH="$BASE_PATH/venv"
SERVICE_NAME="tradeos"

# Check existing installation
if [ -d "$BASE_PATH" ]; then
    log_message "Warning: TradeOS already installed at $BASE_PATH" "$YELLOW"
...
# Clone repository
log_message "Cloning TradeOS repository..." "$BLUE"
sudo git clone https://github.com/TechnoVen/tradeos.git $BASE_PATH
...
# Start service
log_message "Starting TradeOS service..." "$BLUE"
...
if sudo systemctl is-active --quiet $SERVICE_NAME; then
    log_message "\nTradeOS is running successfully!" "$GREEN"
else
