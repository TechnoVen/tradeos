"""
Email Utility Functions for TradeOS
...
def send_test_email(recipient_email, sender_name="TradeOS Admin"):
    """
    ...
    try:
        ...
        subject = "TradeOS - SMTP Test Successful"
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px; text-align: center;">
                            ...
                            <p style="margin: 16px 0 0 0; font-size: 12px; color: #3f3f46;">
                                Sent by <span style="color: #a1a1aa;">TradeOS</span>
                            </p>
                        </td>
                    </tr>
                </table>
...
Your TradeOS SMTP configuration is working correctly.
...
We received a request to reset your TradeOS password. Click the link below to set a new password:
