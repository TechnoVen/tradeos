#!/usr/bin/env python
"""
Telegram Bot Migration Script for TradeOS
    ...
    def __init__(self, db_path=None):
        ...
        if db_path is None:
            ...
            if os.path.basename(script_dir) == "upgrade":
                ...
                db_path = os.path.join(os.path.dirname(script_dir), "db", "tradeos.db")
            else:
                # Running from root directory
                db_path = "db/tradeos.db"
                ...
                if not self.table_exists("telegram_users"):
                    conn.execute(
                        ...
                        CREATE TABLE IF NOT EXISTS telegram_users (
                            ...
                            tradeos_username VARCHAR(255) NOT NULL,
...
def main():
    parser = argparse.ArgumentParser(
        description=f"Telegram Bot Migration for TradeOS - {MIGRATION_DESCRIPTION}"
    )
    parser.add_argument(
