...
- Adds user linking between Telegram and TradeOS
...
1. **Module not found errors**: Ensure you're running from the TradeOS directory with virtual environment:
   ```bash
   cd /path/to/tradeos
...
*For full documentation, see [TradeOS Documentation](../docs/)*