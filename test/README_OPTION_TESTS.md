...
1. Enable **Analyze Mode** in TradeOS settings
2. Run the tests
...
1. Disable **Analyze Mode** in TradeOS settings
2. Run the tests
...
**Solution**: Make sure TradeOS is running at `http://127.0.0.1:5000`
...
{
  "status": "error",
  "message": "Invalid tradeos apikey"
}
```

**Solution**: Replace API key in test file with your actual API key from TradeOS settings
...
- Check TradeOS logs for detailed error messages
