...
class TestMstockBroker(unittest.TestCase):
    def setUp(self):
        ...
        # The test assumes that the TradeOS server is running and
        # the user is already logged into the mstock broker.
        self.api_key = os.getenv(
            "TRADEOS_API_KEY", "3bb8d260915ff680a7258108c0483b9eb7675ced31309a36f5846366943ee9fa"
        )
        self.client = OAClient(api_key=self.api_key, host="http://127.0.0.1:5000")

    def test_place_order(self):
        """Test placing a simple order."""
        # This test requires an active mstock session in the TradeOS server
