...
Make sure the TradeOS application is running before executing this script.

Usage:
    cd D:/tradeos-class/tradeos/test
...
# Add parent directory to path so we can import from tradeos modules if needed
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("TradeOS Options Multi-Order API Test Suite")
    print("=" * 60)
    print(f"\nBase URL: {BASE_URL}")
