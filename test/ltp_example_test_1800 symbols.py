"""
TradeOS WebSocket LTP Example - 1800 Symbols Test
...
# Add parent directory to path to import tradeos
...
try:
    ...
    print("Error: Could not import tradeos. Make sure you're running from the correct directory.")
    sys.exit(1)
...
def main():
    print("TradeOS WebSocket LTP Example - 1800 Symbols Test")
    print("=" * 60)
