...
def transform_data(data, client_id=None, auth_token=None):
    """
    Transforms TradeOS order format to Pocketful order format.
    ...
    Args:
        data: TradeOS order data dictionary
...
def transform_modify_order_data(data, client_id=None):
    """
    Transforms TradeOS order modification format to Pocketful order format.
...
def map_order_type(pricetype):
    """
    Maps TradeOS pricetype to Pocketful order type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
...
def map_product_type(product):
    """
    Maps TradeOS product type to Pocketful product type.
    """
