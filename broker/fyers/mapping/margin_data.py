...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin position format to Fyers margin format.
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to TradeOS standard format.
    ...
    try:
        ...
        # Return standardized format matching TradeOS specification
