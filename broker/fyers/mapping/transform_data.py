...
def transform_data(data):
    """
    Transforms the TradeOS Platform API request structure to the format expected by the Fyers API.
    """
...
def map_order_type(pricetype):
    """
    Maps the TradeOS pricetype to the Fyers order type.
    """
...
def map_action(action):
    """
    Maps the TradeOS action to the Fyers side.
    """
...
def map_product_type(product):
    """
    Maps the TradeOS product type to the Fyers product type.
    """
...
def reverse_map_product_type(product):
    """
    Reverse maps the Fyers product type to the TradeOS product type.
    """
    ...
    if oa_product is None:
        logger.warning(
            f"Unknown Fyers product type '{product}' received. Cannot map to TradeOS product type."
        )
    return oa_product
