...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin position format to Nubra margin format.
...
def map_order_side(action):
    """
    Maps TradeOS action to Nubra order_side.
    """
    mapping = {
        "BUY": "ORDER_SIDE_BUY",
...
def parse_margin_response(response_data):
    """
    Parse Nubra margin calculator response to TradeOS standard format.
    ...
    try:
        ...
        # Return standardized format match TradeOS API specification
        return {
            "status": "success",
            "data": {
