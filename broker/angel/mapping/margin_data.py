...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin position format to Angel Broking margin format.
...
def map_product_type(product):
    """
    Maps TradeOS product type to Angel Broking product type.
...
def map_order_type(pricetype):
    """
    Maps TradeOS price type to Angel Broking order type.

    TradeOS: MARKET, LIMIT, SL, SL-M
...
def parse_margin_response(response_data):
    """
    Parse Angel Broking margin calculator response to TradeOS standard format.
