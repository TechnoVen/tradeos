...
def transform_data(data, token):
    """
    Transforms the TradeOS API request structure to Groww API structure.
...
def transform_modify_order_data(data):
    """
    Transforms the TradeOS order modification data to Groww API structure
...
def map_order_type(pricetype):
    """
    Maps the TradeOS pricetype to Groww order_type values.
    """
    order_type_mapping = {
...
def map_exchange_type(exchange):
    """
    Maps the TradeOS Exchange to Groww Exchange values.
    """
    exchange_mapping = {
        "NSE": EXCHANGE_NSE,
        "BSE": EXCHANGE_BSE,
...
def map_exchange(brexchange):
    """
    Maps the Groww Exchange to TradeOS Exchange format.
    """
    exchange_mapping = {
        EXCHANGE_NSE: "NSE",
        EXCHANGE_BSE: "BSE",
...
def map_product_type(product):
    """
    Maps the TradeOS product type to Groww product type.
    """
...
def reverse_map_product_type(product):
    """
    Maps the Groww product type to the TradeOS product type.
    """
...
def map_segment_type(exchange):
    """
    Maps the TradeOS exchange to Groww segment type.
    """
    segment_mapping = {
        "NSE": SEGMENT_CASH,
        "BSE": SEGMENT_CASH,
...
def map_validity(validity):
    """
    Maps TradeOS validity to Groww validity type.
    """
    validity_mapping = {
        "DAY": VALIDITY_DAY,
        "IOC": VALIDITY_IOC,
...
def map_transaction_type(action):
    """
    Maps TradeOS action to Groww transaction_type.
    """
