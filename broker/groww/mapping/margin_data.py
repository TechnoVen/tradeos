...
def map_margin_exchange(exchange):
    """
    Maps the TradeOS Exchange to Groww Exchange values for margin API.
...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin positions to Groww margin format.
...
def parse_margin_response(response_data):
    """
    Parse Groww margin response to TradeOS standard format.
