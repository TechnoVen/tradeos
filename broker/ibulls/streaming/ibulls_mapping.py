...
class IbullsExchangeMapper:
    """Maps between TradeOS exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {TradeOS_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to TradeOS format
    # Format: {iBulls_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to TradeOS exchange code
