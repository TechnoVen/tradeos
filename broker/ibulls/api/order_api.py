...
def place_smartorder_api(data: dict, auth: str) -> tuple:
    """
    Place a smart order to achieve target position size based on the TradeOS specification.
...
def cancel_order(orderid, auth):
    ...
    # Prepare the payload
    payload = json.dumps({"appOrderID": orderid, "orderUniqueIdentifier": "tradeos"})
