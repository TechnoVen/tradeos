...
class DefinedgeExchangeMapper:
    """Maps TradeOS exchange codes to DefinEdge-specific exchange types"""
    ...
    def get_exchange_code(exchange):
        """
        Convert TradeOS exchange code to DefinEdge exchange code

        Args:
            exchange (str): TradeOS exchange code
