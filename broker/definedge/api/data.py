...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Map Definedge response fields to TradeOS format
    ...
    def get_history(
        ...
        try:
            ...
            if interval == "D":
                ...
                # This ensures the TradeOS client interprets them correctly
            ...
            # Reorder columns to match TradeOS format (timestamp should be 5th column)
