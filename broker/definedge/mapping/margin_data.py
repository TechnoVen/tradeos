...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin positions to Definedge Span Calculator format.
...
def parse_margin_response(response_data):
    """
    Parse Definedge margin response to TradeOS standard format.
    ...
    try:
        ...
        # Return standardized TradeOS format
        return {
            "status": "success",
            "data": {
