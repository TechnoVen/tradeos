...
class UpstoxExchangeMapper:
    """Maps between TradeOS exchange codes and Upstox specific exchange types"""

    # Exchange type mapping for Upstox broker
    # Format: {TradeOS_Exchange: Upstox_Exchange_Code}
    EXCHANGE_TYPES = {
        # NSE Segments
    ...
    # Reverse mapping for converting Upstox exchange codes to TradeOS format
    # Format: {Upstox_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Upstox specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(upstox_code):
        """
        Convert Upstox exchange code to TradeOS exchange code
