...
def get_mstock_symbol(symbol: str, exchange: str) -> str:
    ...
    Args:
        symbol: TradeOS format symbol (e.g., "NHPC")
...
def transform_data(data, token):
    """
    Transforms the TradeOS API request structure to mStock Type B format.

    Args:
        data: TradeOS order data
...
def transform_modify_order_data(data, token):
    """
    Transforms the TradeOS modify order request to mStock Type B format.

    Args:
        data: TradeOS modify order data
        token: Symbol token from database
...
def map_order_type(pricetype):
    """
    Maps TradeOS pricetype to mStock Type B order type.
...
def map_product_type(product):
    """
    Maps TradeOS product type to mStock Type B product type.
...
def map_variety(pricetype):
    """
    Maps TradeOS pricetype to mStock Type B variety.
...
def reverse_map_product_type(product):
    """
    Reverse maps mStock Type B product type to TradeOS product type.
    """
