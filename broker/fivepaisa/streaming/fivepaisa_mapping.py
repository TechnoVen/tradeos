...
class FivePaisaExchangeMapper:
    """Maps TradeOS exchange codes to 5Paisa-specific exchange codes"""
    ...
    def get_exchange_code(exchange: str) -> str:
        """
        Convert TradeOS exchange code to 5Paisa exchange code

        Args:
            exchange (str): TradeOS exchange code (e.g., 'NSE', 'BSE', 'NFO')
    ...
    def get_exchange_type(exchange: str) -> str:
        """
        Convert TradeOS exchange to 5Paisa exchange type
