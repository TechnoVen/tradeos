...
class CompositedgeExchangeMapper:
    """Maps between TradeOS exchange codes and Compositedge XTS specific exchange types"""

    # Exchange type mapping for Compositedge XTS broker
    # Format: {TradeOS_Exchange: Compositedge_Exchange_Code}
    ...
    # Reverse mapping for converting Compositedge exchange codes to TradeOS format
    # Format: {Compositedge_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Compositedge XTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(compositedge_code):
        """
        Convert Compositedge XTS exchange code to TradeOS exchange code

        Args:
            compositedge_code (int): Compositedge exchange code

        Returns:
            str: TradeOS exchange code
        """
