...
class FivepaisaXTSExchangeMapper:
    """Maps between TradeOS exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {TradeOS_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to TradeOS format
    # Format: {Fivepaisa_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to TradeOS exchange code
