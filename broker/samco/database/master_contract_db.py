...
def process_samco_data(df):
    """
    Process Samco ScripMaster CSV data to fit the TradeOS database schema.
    """
    ...
    # Convert expiry date to TradeOS format (DD-MMM-YY)
    ...
    # Map index instruments to TradeOS exchange format
