...
class JainamXTSExchangeMapper:
    """Maps between TradeOS exchange codes and JainamXTS specific exchange types"""

    # Exchange type mapping for JainamXTS broker
    # Format: {TradeOS_Exchange: JainamXTS_Exchange_Code}
    ...
    # Reverse mapping for converting JainamXTS exchange codes to TradeOS format
    # Format: {JainamXTS_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to JainamXTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(jainamxts_code):
        """
        Convert JainamXTS exchange code to TradeOS exchange code
