...
class WisdomExchangeMapper:
    """Maps between TradeOS exchange codes and Wisdom XTS specific exchange types"""

    # Exchange type mapping for Wisdom XTS broker
    # Format: {TradeOS_Exchange: Wisdom_Exchange_Code}
    ...
    # Reverse mapping for converting Wisdom exchange codes to TradeOS format
    # Format: {Wisdom_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Wisdom XTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(wisdom_code):
        """
        Convert Wisdom XTS exchange code to TradeOS exchange code
