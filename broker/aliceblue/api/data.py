...
class BrokerData:
    ...
    def get_quotes(self, symbol_list, timeout: int = 5) -> list[dict[str, Any]]:
        ...
        # Special case for TradeOS standard format: direct quote request via Bruno
                ...
                if token:
                    ...
                    if websocket and websocket.is_connected:
                        ...
                        if success:
                            ...
                            if quote:
                                # Format the response according to TradeOS standard format
                                quote_item = {
                                    "symbol": symbol,
                                    "exchange": exchange,
                                    "token": token,
    ...
    def get_depth(self, symbol_list, timeout: int = 5):
        ...
        Returns:
            Dict with market depth data in the TradeOS standard format
        """
