...
class AliceblueWebSocketAdapter(BaseBrokerWebSocketAdapter):
                ...
                with self.lock:
                    ...
                    if mode > existing_mode:
                        self.subscriptions[sub_key] = {
                            ...
                            "original_symbol": symbol,  # Store original TradeOS symbol for lookup
                            "original_exchange": exchange,  # Store original TradeOS exchange
    ...
    def _on_data_received(self, parsed_data):
        ...
        try:
            ...
            # Also, for NFO/BFO symbols, AliceBlue returns broker symbols but we need TradeOS symbols
