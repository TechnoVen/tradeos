...
class IiflExchangeMapper:
    """Maps between TradeOS exchange codes and Iifl XTS specific exchange types"""

    # Exchange type mapping for Iifl XTS broker
    # Format: {TradeOS_Exchange: Iifl_Exchange_Code}
    ...
    # Reverse mapping for converting Iifl exchange codes to TradeOS format
    # Format: {Iifl_Exchange_Code: TradeOS_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert TradeOS exchange code to Iifl XTS specific exchange type
    ...
    @staticmethod
    def get_tradeos_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to TradeOS exchange code
