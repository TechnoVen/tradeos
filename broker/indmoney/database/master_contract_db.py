...
def reformat_symbol(row, file_segment=None):
    """
    Reformat symbols according to TradeOS standards based on Indmoney data structure
    """
    ...
    # Format expiry date for TradeOS format (DDMMMYY)
...
def process_indmoney_csv(path):
    ...
    for segment in ["equity", "fno", "index"]:
        ...
        # Generate TradeOS formatted symbol
