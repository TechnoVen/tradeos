...
def map_trade_data(trade_data):
    ...
    try:
        ...
        for trade in trade_data:
            ...
            # Map product type from IndMoney format to TradeOS format
...
def transform_tradebook_data(tradebook_data):
    """
    Transform trade book data to TradeOS standard format.
...
def transform_positions_data(positions_data):
    """
    Transform positions data to TradeOS standard format.
    Matches the structure used by Angel broker for consistency.

    TradeOS Standard Fields:
    ...
    try:
        ...
        for position in positions_data:
            ...
            # TradeOS standard format (matching Angel broker structure)
