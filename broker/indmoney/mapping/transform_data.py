...
def transform_data(data, token):
    """
    Transforms the TradeOS API request structure to Indmoney API structure.
    ...
    # Basic mapping from TradeOS to Indmoney
...
def transform_modify_order_data(data):
    """
    Transforms TradeOS modify order data to Indmoney format.
    """
    transformed = {
...
def map_order_type(pricetype):
    """
    Maps TradeOS pricetype to Indmoney order_type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
...
def map_segment(exchange):
    """
    Maps TradeOS exchange to Indmoney segment.
    """
    segment_mapping = {
        "NSE": "EQUITY",
        "BSE": "EQUITY",
...
def map_exchange_type(exchange):
    """
    Maps TradeOS exchange to Indmoney exchange format.
    """
    exchange_mapping = {
        "NSE": "NSE",
        "BSE": "BSE",
...
def map_exchange(br_exchange):
    """
    Maps Indmoney exchange back to TradeOS exchange.
    """
...
def map_product_type(product):
    """
    Maps TradeOS product type to Indmoney product type.
    """
...
def reverse_map_product_type(product):
    """
    Maps Indmoney product type back to TradeOS product type.
    """
