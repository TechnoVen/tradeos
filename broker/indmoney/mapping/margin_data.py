...
def transform_margin_positions(positions):
    """
    Transform TradeOS margin position format to IndMoney margin format.
...
def map_segment(exchange):
    ...
    TradeOS: NSE, BSE, NFO, BFO, CDS, BCD, MCX
...
def parse_margin_response(response_data):
    """
    Parse IndMoney margin calculator response to TradeOS standard format.
    ...
    try:
        ...
        # Extract only the three required values as per TradeOS API specification
