...
# Default response format for margin data (TradeOS standard format)
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        try:
            ...
            # TradeOS standard required keys (matching Angel broker format)
            required_keys = [
                "availablecash",
                "collateral",
                "m2mrealized",
            ...
            # Prepare the response in TradeOS standard format
            processed_data = {}

            # Map INDmoney fields to TradeOS standard fields
            field_mapping = {
