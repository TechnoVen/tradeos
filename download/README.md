...
This tool allows you to download Intraday End of Day (IEOD) data for specified stock symbols from the TradeOS API.

## Prerequisites

- Python 3.x
- Valid TradeOS API key
- Access to TradeOS API endpoint (ensure tradeos is running)
...
1. Ensure you have a valid API key from TradeOS
