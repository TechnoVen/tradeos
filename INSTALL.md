...
Before installing TradeOS, ensure you have the following prerequisites installed:
...
2. **Clone the Repository**: 
   Open the VS Code Terminal and clone the TradeOS repository:
   ```bash
...
5. **Configure Environment Variables**: 
   - Rename `.sample.env` to `.env` in the `tradeos` folder
...
For more detailed configuration instructions, visit [https://docs.tradeos.in](https://docs.tradeos.in)
