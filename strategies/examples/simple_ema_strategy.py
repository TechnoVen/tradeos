...
This strategy demonstrates how to integrate with TradeOS API
"""
...
# Get API key from tradeos portal
api_key = os.getenv('TRADEOS_APIKEY')

if not api_key:
    print("Error: TRADEOS_APIKEY environment variable not set")
    exit(1)


# Set the strategy details and trading parameters
strategy = "EMA Crossover Python"
symbol = 'NHPC'  # TradeOS Symbol
exchange = "NSE"
product = "MIS"
quantity = 1
...
def ema_strategy():
    ...
    while True:
        try:
            ...
            # Fetch 1-minute historical data using TradeOS
            df = client.history(
                symbol=symbol,
                exchange=exchange,
                interval="1m",
