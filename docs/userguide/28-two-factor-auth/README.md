...
Two-Factor Authentication (2FA) adds an extra layer of security to your TradeOS account. Even if someone knows your password, they can't access your account without the second factor - a time-based code from your authenticator app.
...
| Wrong account | Verify you're using TradeOS entry |
...
A: No, TradeOS uses TOTP apps only (more secure than SMS).
