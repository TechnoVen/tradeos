# TradeOS Symbol Format Guide

## Introduction

TradeOS uses a standardized symbol format across all exchanges and brokers. This uniform symbology eliminates the need for traders to adapt to varied broker-specific formats, streamlining algorithm development and execution.
...
| Company | Base Symbol | TradeOS Symbol |
|---------|-------------|-----------------|
...
TradeOS uses standardized exchange codes to identify trading venues.
...
### Method 1: TradeOS Symbol Search
...
TradeOS maintains a master contract database that maps broker symbols to standardized symbols. The database is updated daily.
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TradeOS Symbol Quick Reference                          │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  TYPE          FORMAT                      EXAMPLE                          │
│  ────          ──────                      ───────                          │
