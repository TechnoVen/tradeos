...
GoCharting is a modern web-based charting platform designed specifically for Indian markets. It offers TradingView-style functionality with native support for Indian exchanges. TradeOS integrates seamlessly with GoCharting's webhook system for automated trading.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    GoCharting → TradeOS Flow                               │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ GoCharting  │     │   Webhook   │     │  TradeOS   │     │  Broker  │  │
...
GoCharting webhooks need to reach your TradeOS server from the internet.
...
2. Enter URL: `https://your-tradeos-url/api/v1/placeorder`
...
- Check TradeOS dashboard
- Review trade logs
- Verify position accuracy

## Troubleshooting

### Webhook Not Reaching TradeOS
