...
TradingView is a popular charting platform with powerful Pine Script strategy capabilities. TradeOS connects TradingView alerts to your broker for automated order execution.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TradingView → TradeOS Flow                              │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ TradingView │     │   Webhook   │     │  TradeOS   │     │  Broker  │  │
...
TradingView webhooks need to reach your TradeOS server from the internet.
...
```pine
//@version=5
strategy("My TradeOS Strategy", overlay=true)
...
```
https://your-tradeos-url/api/v1/placesmartorder
```
...
1. Go to **Analyzer** page in TradeOS
