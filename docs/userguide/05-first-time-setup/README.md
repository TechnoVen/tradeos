...
You've installed TradeOS. Now let's configure it properly for secure operation and connect it to your broker.

## Setup Wizard Overview

When you first access TradeOS, you'll go through these steps:
...
Before using TradeOS, you MUST set unique security keys.
...
4. Authorize TradeOS
5. You'll be redirected back to TradeOS
...
Congratulations! TradeOS is now set up. Your next steps:
