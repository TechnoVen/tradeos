...
TradeOS is an open-source algorithmic trading platform that connects various trading platforms (TradingView, Amibroker, Python) to Indian stock brokers through a unified API.

### Is TradeOS free?

Yes, TradeOS is completely free and open-source. You can download, use, and modify it without any cost.

### Which brokers are supported?

TradeOS supports 24+ Indian brokers including:
- Zerodha
- Angel One
- Dhan
- Upstox
...
### Can I use TradeOS for live trading?

Yes, TradeOS supports live trading with real money. However, we strongly recommend:
...
### Can I run TradeOS on a VPS/Cloud?

Yes, TradeOS can run on:
- AWS EC2/Lightsail
- Google Cloud
- DigitalOcean
- Azure
...
Most Indian brokers require daily authentication for security. This is a broker requirement, not an TradeOS limitation.

### Can I use multiple brokers?

Currently, TradeOS supports one broker at a time. You can switch between brokers by changing the configuration.
...
Yes, TradeOS fully supports F&O trading. Use correct symbol format:
- Futures: `NIFTY30JAN25FUT`
- Options: `NIFTY30JAN2521500CE`

### What is Analyzer Mode?

Analyzer Mode is TradeOS's sandbox testing environment. It simulates trading with ₹1 Crore sandbox capital using real market prices but no real money.

### Can I backtest strategies?

TradeOS is primarily for live trading and walkforward testing strategies. For backtesting:
- Use TradingView's strategy tester
- Use Amibroker's backtesting
- Use Python backtesting libraries

### What happens if TradeOS crashes during a trade?
...
### How do I connect TradingView to TradeOS?

1. Enable TradeOS accessible via internet (ngrok/cloud)
2. Create webhook alert in TradingView
3. Use TradeOS endpoint URL
...
Report security vulnerabilities to: security@tradeos.io (or via GitHub private advisory)
...
TradeOS is community-driven. Get help through:

1. Documentation: [https://docs.tradeos.io](https://docs.tradeos.io)
2. Discord Community: [http://tradeos.io/discord](http://tradeos.io/discord)
3. GitHub Issues: [https://github.com/TechnoVen/tradeos/issues](https://github.com/TechnoVen/tradeos/issues)
...
### Is TradeOS really free?

Yes, TradeOS is 100% free and open-source under the AGPL license.

### Are there any hidden costs?

No hidden costs from TradeOS. You may have:
...
### "TradeOS is a trading bot"

TradeOS is a **bridge/platform**, not a trading bot. It connects your strategy signals to your broker. You still need to create or use existing strategies.

### "I can make guaranteed profits"

No trading system guarantees profits. TradeOS is a tool - your results depend on your strategy.

### "It works without internet"

TradeOS requires internet connection to communicate with brokers and receive signals.

### "I can trade after market hours"

TradeOS follows exchange timings. F&O can be traded during extended hours as per exchange rules.
...
2. Check [GitHub Discussions](https://github.com/TechnoVen/tradeos/discussions)
