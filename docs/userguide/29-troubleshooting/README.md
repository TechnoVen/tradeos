...
This guide helps you diagnose and resolve common issues in TradeOS. Problems are organized by category with step-by-step solutions.
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  □ Is TradeOS running? (Check terminal/service status)                    │
...
**Symptom**: TradingView/ChartInk alerts not reaching TradeOS

**Checklist**:
1. Is TradeOS accessible from internet?
   ```bash
   # Test with curl from external machine
   curl https://your-tradeos-url/health
   ```
...
**Solution**:
1. Copy API key from TradeOS dashboard
...
**Symptom**: TradeOS consuming too much RAM
...
TradeOS is community-driven:

| Channel | Use For | Link |
|---------|---------|------|
| GitHub Issues | Bug reports, feature requests | [github.com/TechnoVen/tradeos/issues](https://github.com/TechnoVen/tradeos/issues) |
| Discord | Community support, questions | [tradeos.io/discord](http://tradeos.io/discord) |
| Documentation | How-to guides | [docs.tradeos.io](https://docs.tradeos.io) |

### Useful Commands

```bash
# Check TradeOS version
uv run python -c "import tradeos; print(tradeos.__version__)"
