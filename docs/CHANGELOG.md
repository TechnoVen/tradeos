...
- Order field names aligned with TradeOS schema
...
- What is TradeOS, Key Concepts, System Requirements
...
- TradeOS symbol format reference
...
- `db/tradeos.db` - Main database (users, orders, settings)
...
See [GitHub Releases](https://github.com/TechnoVen/tradeos/releases) for previous version history.
...
- **YouTube**: https://www.youtube.com/@tradeos
