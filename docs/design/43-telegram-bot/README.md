...
TradeOS integrates with Telegram to provide real-time trading notifications, account information, and bot commands. Users can configure their Telegram bot to receive order alerts, position updates, and execute queries.
...
│ user_id          │ VARCHAR(255) │ TradeOS user ID             │
...
├──────────────────┼──────────────┼──────────────────────────────┤
│ id               │ INTEGER PK   │ Auto-increment               │
│ user_id          │ VARCHAR(255) │ TradeOS user ID (unique)    │
