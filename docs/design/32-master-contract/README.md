...
Master contracts contain symbol mappings between TradeOS's standardized format and broker-specific formats. They are downloaded daily and cached for fast symbol resolution.
...
│ symbol       │ VARCHAR      │ TradeOS symbol format           │
