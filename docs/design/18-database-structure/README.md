...
TradeOS uses **5 separate databases** for data isolation, performance optimization, and specialized use cases. This separation prevents contention and allows each database to be optimized for its specific workload.
...
## Database 1: Main Database (tradeos.db)
...
│ overhead_ms      │ FLOAT        │ TradeOS overhead│
...
| overhead_ms | Total TradeOS overhead |
