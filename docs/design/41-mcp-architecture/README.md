...
TradeOS includes an MCP (Model Context Protocol) server that enables AI assistants like Claude, Cursor, and Windsurf to control trading operations through natural language commands.
...
// ~/Library/Application Support/Claude/claude_desktop_config.json
{
  "mcpServers": {
    "tradeos": {
      "command": "/path/to/tradeos/.venv/bin/python3",
      "args": [
        "/path/to/tradeos/mcp/mcpserver.py",
        "YOUR_API_KEY",
        "http://127.0.0.1:5000"
      ]
    }
...
tradeos==1.0.45      # TradeOS Python client
...
| External: `tradeos` package | Python client library |
