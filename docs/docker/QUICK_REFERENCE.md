...
### Test numba/scipy
```bash
docker exec tradeos python -c "import numba, llvmlite, scipy; print('✓ Working')"
```

### Test Strategy Indicators
```bash
docker exec tradeos python -c "
...
2. Verify volumes: `docker inspect tradeos`
3. Test imports: `docker exec tradeos python -c "import numba, scipy"`
4. Join Discord: https://discord.com/invite/UPh7QPsNhP
5. GitHub Issues: https://github.com/TechnoVen/tradeos/issues
