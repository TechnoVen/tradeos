...
def start_strategy(strategy_id):
    ...
    # Prepare environment
    env = os.environ.copy()
    env['TRADEOS_APIKEY'] = get_api_key()
    env['TRADEOS_HOST'] = get_host_url()
...
> **Reference**: [GitHub Issue #822](https://github.com/TechnoVen/tradeos/issues/822) documents the RLIMIT_NPROC fix.
