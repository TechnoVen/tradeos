...
Python Strategies enables traders to run custom Python trading algorithms within TradeOS, with process isolation, market-aware scheduling, and comprehensive lifecycle management.
...
| ID | Requirement | Priority |
|----|-------------|----------|
| FR6.1 | TradeOS SDK available to strategies | P0 |
| FR6.2 | Environment variables for API key | P0 |
| FR6.3 | Access to all TradeOS API endpoints | P0 |
...
> **Note**: Thread limits (`OPENBLAS_NUM_THREADS`, etc.) prevent RLIMIT_NPROC exhaustion when using NumPy/SciPy/Numba. See [Issue #822](https://github.com/TechnoVen/tradeos/issues/822).
