...
├── flow_tradeos_client.py     # TradeOS API wrapper (~500 lines)
...
| `FlowTradeOSClient` | Wraps TradeOS internal APIs |
...
def execute_workflow(
    ...
    # 3. Create executor with TradeOS client
    client = FlowTradeOSClient(api_key)
