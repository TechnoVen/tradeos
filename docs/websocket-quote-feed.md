...
This guide demonstrates how to integrate with TradeOS's WebSocket quote feed for real-time market data streaming.

## Overview

TradeOS provides a unified WebSocket server (port 8765) that streams market data from 24+ brokers in a normalized format. Clients can subscribe to LTP, Quote, or Depth modes.
