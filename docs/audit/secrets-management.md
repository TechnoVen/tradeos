...
This assessment covers how TradeOS protects your sensitive data: broker credentials, API keys, and encryption secrets.

**Risk Level**: Critical (data sensitivity)
**Status**: Good

## What Secrets Does TradeOS Store?
...
|------|----------|-------------|
| `tradeos.db` | Users, orders, settings | High |
...
- [ ] Strong password for TradeOS login
...
**Actions**:
1. Logout from TradeOS
2. Revoke broker tokens (in broker dashboard)
3. Generate new API key in TradeOS
