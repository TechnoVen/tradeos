...
This assessment covers the security of TradeOS's REST API, focusing on protecting your trading operations from unauthorized access via webhooks.
...
TradeOS API is accessed in two scenarios:
