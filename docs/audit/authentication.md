...
TradeOS implements authentication to protect access to your personal trading dashboard and prevent unauthorized order placement.
...
TradeOS uses Argon2id - the winner of the Password Hashing Competition and OWASP's top recommendation.
...
TradeOS supports time-based one-time passwords (TOTP) compatible with:
