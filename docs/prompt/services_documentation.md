# TradeOS Services Documentation

## Overview

TradeOS Services are Python functions that provide programmatic access to trading operations. These services mirror the functionality of the TradeOS SDK but are designed for internal use within the TradeOS application. Each service function accepts the same request parameters and returns the same responses as documented in the TradeOS SDK.
...
**Location:** `tradeos/services/place_order_service.py`
...
| api_key | str | Conditional | TradeOS API key (for API-based calls) |
...
**Location:** `tradeos/services/place_smart_order_service.py`
...
| api_key | str | Conditional | TradeOS API key |
...
**Location:** `tradeos/services/place_options_order_service.py`
...
**Location:** `tradeos/services/options_multiorder_service.py`
...
**Location:** `tradeos/services/basket_order_service.py`
...
**Location:** `tradeos/services/split_order_service.py`
...
**Location:** `tradeos/services/modify_order_service.py`
...
**Location:** `tradeos/services/cancel_order_service.py`
...
**Location:** `tradeos/services/cancel_all_order_service.py`
...
**Location:** `tradeos/services/close_position_service.py`
...
**Location:** `tradeos/services/orderstatus_service.py`
...
**Location:** `tradeos/services/openposition_service.py`
...
**Location:** `tradeos/services/quotes_service.py`
...
**Location:** `tradeos/services/depth_service.py`
...
**Location:** `tradeos/services/history_service.py`
...
**Location:** `tradeos/services/intervals_service.py`
...
**Location:** `tradeos/services/symbol_service.py`
...
**Location:** `tradeos/services/search_service.py`
...
**Location:** `tradeos/services/expiry_service.py`
...
**Location:** `tradeos/services/instruments_service.py`
...
| api_key | str | Yes | TradeOS API key |
...
**Location:** `tradeos/services/option_symbol_service.py`
...
**Location:** `tradeos/services/option_chain_service.py`
...
**Location:** `tradeos/services/synthetic_future_service.py`
...
**Location:** `tradeos/services/option_greeks_service.py`
...
**Location:** `tradeos/services/funds_service.py`
...
**Location:** `tradeos/services/margin_service.py`
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| apikey | str | Yes | TradeOS API key |
...
**Location:** `tradeos/services/orderbook_service.py`
...
**Location:** `tradeos/services/tradebook_service.py`
...
**Location:** `tradeos/services/positionbook_service.py`
...
**Location:** `tradeos/services/holdings_service.py`
...
**Location:** `tradeos/services/market_calendar_service.py`
...
**Location:** `tradeos/services/analyzer_service.py`
...
The Telegram Alert Service provides automated notifications for order-related events via Telegram. This service is not part of the SDK yet but is available for internal use within TradeOS.

**Location:** `tradeos/services/telegram_alert_service.py`
...
- GitHub: https://github.com/TechnoVen/tradeos
