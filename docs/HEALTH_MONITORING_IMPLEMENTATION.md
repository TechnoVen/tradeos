...
<html>
<head>
    <title>System Health Monitor - TradeOS</title>
    <!-- Add your styles -->
</head>
<body>
    <div class="container">
...
tail -f logs/tradeos.log | grep -i health
...
fd_gauge = Gauge('tradeos_fd_count', 'File descriptor count')
memory_gauge = Gauge('tradeos_memory_mb', 'Memory usage in MB')
