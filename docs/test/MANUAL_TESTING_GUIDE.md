# TradeOS v2.0 - Comprehensive Manual Testing Guide
...
| Test | Steps | Expected | Status |
|------|-------|----------|--------|
| Build image | `docker build -t tradeos .` | Image built | [ ] |
| Run container | `docker run -p 5000:5000 tradeos` | App accessible | [ ] |
...
## Appendix: TradeOS Symbol Format
