# services/flow_tradeos_client.py
"""
TradeOS Client Wrapper for Flow
Provides SDK-like interface using internal TradeOS services
"""
...
class FlowTradeOSClient:
    """
    Client wrapper that provides SDK-like interface to TradeOS services.
    ...
    def __init__(self, api_key: str):
        ...
        Args:
            api_key: The TradeOS API key for authentication
        """
    ...
    def get_open_position(
        ...
        Returns quantity matching standard TradeOS API response.
        """
...
def get_flow_client(api_key: str) -> FlowTradeOSClient:
    """
    Factory function to create a Flow TradeOS client.

    Args:
        api_key: The TradeOS API key

    Returns:
        FlowTradeOSClient instance
    """
    return FlowTradeOSClient(api_key)
