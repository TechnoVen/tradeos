...
Checks file and directory permissions for TradeOS components.
...
def get_permission_checks():
    ...
    # Format: 'sqlite:///db/tradeos.db' -> 'db/tradeos.db'
    ...
    main_db = extract_db_path("DATABASE_URL", "db/tradeos.db")
...
def get_base_path():
    """Get the base path of the TradeOS application."""
